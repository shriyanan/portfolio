...
for each in range(num):
	...
	ball_size = random.randint(10, 80)
	
	
	ball = BouncingBall(300, 200, x_speed, y_speed, ball_size)
...
while not done:
    ...
    for item in balls:
    	item.flashBounce(screen, random.choice(possible_ball_colors), SCREEN_WIDTH, SCREEN_HEIGHT)
